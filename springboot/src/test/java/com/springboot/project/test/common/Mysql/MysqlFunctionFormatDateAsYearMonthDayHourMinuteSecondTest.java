...
public class MysqlFunctionFormatDateAsYearMonthDayHourMinuteSecondTest extends BaseTest {
    private String zoneOffset;

    @Test
    public void test() {
        assertThrows(RuntimeException.class, () -> {
            MysqlFunction.formatDateAsYearMonthDayHourMinuteSecond(new Date(), this.zoneOffset);
        });
    }
