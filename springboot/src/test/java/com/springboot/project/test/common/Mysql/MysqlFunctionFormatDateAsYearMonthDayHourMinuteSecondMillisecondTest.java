...
public class MysqlFunctionFormatDateAsYearMonthDayHourMinuteSecondMillisecondTest extends BaseTest {
    private String zoneOffset;

    @Test
    public void test() {
        assertThrows(RuntimeException.class, () -> {
            MysqlFunction.formatDateAsYearMonthDayHourMinuteSecondMillisecond(new Date(), this.zoneOffset);
        });
    }
