...
import com.springboot.project.format.UserSignInVerificationCodeFormatter;
...
public abstract class BaseService {
    ...
    @Autowired
    protected UserSignInVerificationCodeFormatter userSignInVerificationCodeFormatter;
    ...
    protected JPAJinqStream<UserSignInVerificationCodeEntity> UserSignInVerificationCodeEntity() {
        return this.streamAll(UserSignInVerificationCodeEntity.class);
    }
        ...
        if (this.jinqJPAStreamProvider == null) {
            synchronized (getClass()) {
                if (this.jinqJPAStreamProvider == null) {
                    ...
                    MysqlFunction.registerCustomSqlFunction(jinqJPAStreamProvider);
