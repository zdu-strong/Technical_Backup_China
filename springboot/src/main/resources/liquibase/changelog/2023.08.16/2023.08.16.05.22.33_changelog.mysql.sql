...
-- changeset John:1692163368436-1
...
-- changeset John:1692163368436-2
...
-- changeset John:1692163368436-3
CREATE TABLE logger_entity (id VARCHAR(255) NOT NULL, caller_class_name VARCHAR(255) NOT NULL, caller_line_number INT NOT NULL, caller_method_name VARCHAR(255) NOT NULL, create_date datetime NOT NULL, exception_class_name VARCHAR(255) NOT NULL, exception_message VARCHAR(255) NOT NULL, exception_stack_trace LONGTEXT NOT NULL, git_commit_date datetime NOT NULL, git_commit_id VARCHAR(255) NOT NULL, has_exception BIT(1) NOT NULL, level VARCHAR(255) NOT NULL, logger_name VARCHAR(255) NOT NULL, message VARCHAR(255) NOT NULL, update_date datetime NOT NULL, CONSTRAINT PK_LOGGER_ENTITY PRIMARY KEY (id));

-- changeset John:1692163368436-4
...
-- changeset John:1692163368436-5
...
-- changeset John:1692163368436-6
...
-- changeset John:1692163368436-7
CREATE TABLE organize_shadow_entity (id VARCHAR(255) NOT NULL, create_date datetime NOT NULL, is_deleted BIT(1) NOT NULL, name VARCHAR(255) NOT NULL, update_date datetime NOT NULL, parent_id VARCHAR(255) NULL, CONSTRAINT PK_ORGANIZE_SHADOW_ENTITY PRIMARY KEY (id));

-- changeset John:1692163368436-8
...
-- changeset John:1692163368436-9
...
-- changeset John:1692163368436-10
CREATE TABLE user_email_entity (id VARCHAR(255) NOT NULL, create_date datetime NOT NULL, delete_key VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, is_deleted BIT(1) NOT NULL, update_date datetime NOT NULL, verification_code VARCHAR(255) NOT NULL, user_id VARCHAR(255) NOT NULL, CONSTRAINT PK_USER_EMAIL_ENTITY PRIMARY KEY (id));

-- changeset John:1692163368436-11
CREATE TABLE user_entity (id VARCHAR(255) NOT NULL, create_date datetime NOT NULL, has_registered BIT(1) NOT NULL, is_deleted BIT(1) NOT NULL, private_key_ofrsa LONGTEXT NOT NULL, public_key_ofrsa LONGTEXT NOT NULL, update_date datetime NOT NULL, username VARCHAR(255) NOT NULL, CONSTRAINT PK_USER_ENTITY PRIMARY KEY (id));

-- changeset John:1692163368436-12
CREATE TABLE user_message_entity (id VARCHAR(255) NOT NULL, content LONGTEXT NOT NULL, create_date datetime NOT NULL, file_name LONGTEXT NOT NULL, folder_name VARCHAR(255) NULL, folder_size BIGINT NULL, is_recall BIT(1) NOT NULL, update_date datetime NOT NULL, user_id VARCHAR(255) NOT NULL, CONSTRAINT PK_USER_MESSAGE_ENTITY PRIMARY KEY (id));

-- changeset John:1692163368436-13
ALTER TABLE user_email_entity ADD CONSTRAINT UK3p1gui2lihpiaob8vx1y00hum UNIQUE (email, delete_key);

-- changeset John:1692163368436-14
ALTER TABLE friendship_entity ADD CONSTRAINT UK9d80pp0etnmlwc9nqbo1wnjj6 UNIQUE (user_id, friend_id);

-- changeset John:1692163368436-15
CREATE INDEX FK23c715x0gcdv29x9l92r8dc74 ON user_message_entity(user_id);

-- changeset John:1692163368436-16
CREATE INDEX FK87p106yrm418be8a0scsu0ig5 ON organize_shadow_entity(parent_id);

-- changeset John:1692163368436-17
CREATE INDEX FKchycpasyr16kt66k09e6ompve ON token_entity(user_id);

-- changeset John:1692163368436-18
CREATE INDEX FKfrbs0stjmmje4we9n1t0cf0oh ON organize_closure_entity(ancestor_id);

-- changeset John:1692163368436-19
CREATE INDEX FKgacw5qpr2xa2hdenbtqo6tcb0 ON organize_entity(organize_shadow_id);

-- changeset John:1692163368436-20
CREATE INDEX FKpq2at14h3gljwg848p43aw14w ON friendship_entity(friend_id);

-- changeset John:1692163368436-21
CREATE INDEX FKq1njl6uveplkpgu70115gbf5o ON user_email_entity(user_id);

-- changeset John:1692163368436-22
CREATE INDEX FKrq3vl8q12mdppvdre3bcv6fce ON organize_closure_entity(descendant_id);

-- changeset John:1692163368436-23
...
-- changeset John:1692163368436-24
...
-- changeset John:1692163368436-25
...
-- changeset John:1692163368436-26
...
-- changeset John:1692163368436-27
...
-- changeset John:1692163368436-28
...
-- changeset John:1692163368436-29
...
-- changeset John:1692163368436-30
...
-- changeset John:1692163368436-31
